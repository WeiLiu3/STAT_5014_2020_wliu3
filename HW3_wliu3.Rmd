...
print(violinplot1 + ggtitle("A volin plot from two devevices, by Observer")+labs(x = "observer"))
```
...
print(scatterplot + ggtitle("A scatterplot from two devevices, by Observer")+labs(x = "observer"))
```
